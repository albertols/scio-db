...
/**
 * --project=db-dev-apyd-pwcclake-es
 * --runner=DirectRunner
 * --tempLocation=gs://db-dev-europe-west3-gcs-125479-2-temp
 * --bqTable=db-dev-apyd-pwcclake-es.CDH_dataset.scio_test
 * --pubSubTopic=projects/db-dev-apyd-pwcclake-es/subscriptions/pc_kw111t-sub
