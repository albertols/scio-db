...
import com.db.myproject.mediation.testing.NotificationsMockData.{not_sent_debit_abuela, not_sent_debit_quique, true_sent_debit_quique}
...
object LocalAvroDump {
  def main(cmdlineArgs: Array[String]): Unit = {
    ...
    val avros: SCollection[MyEventRecord] = sc.parallelize(mockManyRecordsSeq(1, not_sent_debit_abuela, false))
