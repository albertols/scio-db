...
object MinimalPubSubBQLookup {
  ...
  def main(cmdlineArgs: Array[String]): Unit = {
    ...
    val bqTable: String = args.getOrElse("bqTable", "your_project.your_dataset.scio_test")
    val pubSubTopic: String = args.getOrElse("pubSubTopic", "projects/your_project/subscriptions/your_topic")
  ...
  // bq load --autodetect --source_format=CSV --skip_leading_rows=0 your_project.your_dataset.scio_test gs://europe-west3-db-dev-pwcclak-3c7ede6b-bucket/dags/big.sql
